 ...
 */
public class InvatitionRVAdapter extends RecyclerView.Adapter<InvatitionRVAdapter.ViewHolder> {

    private final List<GetSetData> mValues;
    private final invatitionFragment.OnListFragmentInteractionListener mListener;

    public InvatitionRVAdapter(List<GetSetData> items, invatitionFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
